/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: d4fd87f1758713a96a98cf933c77f3b8)
// Runtime types generated with workerd@1.20260708.1 2026-03-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SHADCNBLOCKS_EMAIL: string;
	SHADCNBLOCKS_API_KEY_NAME: string;
	SHADCNBLOCKS_API_KEY: string;
	SHADCNSTUDIO_EMAIL: string;
	SHADCNSTUDIO_LICENSE_KEY: string;
	...
	STITCH_WITHGOOGLE_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHADCNBLOCKS_EMAIL" | "SHADCNBLOCKS_API_KEY_NAME" | "SHADCNBLOCKS_API_KEY" | "SHADCNSTUDIO_EMAIL" | "SHADCNSTUDIO_LICENSE_KEY" | "RESEND_API_KEY" | "CONTACT_TO_EMAIL" | "CONTACT_FROM_EMAIL" | "CLOUDFLARE_ACCOUNT_ID" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "NEXTJS_ENV" | "LIGHTHOUSE_URL" | "STITCH_WITHGOOGLE_API_KEY" | "STRIPE_TEST_PUBLISHABLE_KEY" | "STRIPE_TEST_SECRET_KEY" | "STRIPE_LIVE_PUBLISHABLE_KEY" | "STRIPE_LIVE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_LIVE_WEBHOOK_SECRET">> {}
}
