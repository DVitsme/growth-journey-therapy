/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ea3903f15563a11423277c0ca911b8b5)
// Runtime types generated with workerd@1.20260708.1 2026-03-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	FORM_FAILSAFE: R2Bucket;
	...
	CLOUDFLARE_API_DNS_TOKEN: string;
	NEXT_PUBLIC_TURNSTILE_SITE_KEY: string;
	TURNSTILE_SECRET_KEY: string;
	NEXTJS_ENV: string;
	LIGHTHOUSE_URL: string;
	NEXT_PUBLIC_SITE_PHASE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_KEY" | "CONTACT_TO_EMAIL" | "CONTACT_FROM_EMAIL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_API_DNS_TOKEN" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "NEXTJS_ENV" | "LIGHTHOUSE_URL" | "NEXT_PUBLIC_SITE_PHASE">> {}
}
